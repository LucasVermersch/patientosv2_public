...
class UtilisateurAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        $patient = $this->entityManager->getRepository(Patient::class)->findOneBy(['email' => $credentials['email']]);


        if(!$user && !$patient){
            throw new CustomUserMessageAuthenticationException("L'email n'est pas connu ! Inscrivez vous!");
